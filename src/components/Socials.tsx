                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-4 w-full">
                    <div className="p-3 bg-white/80 rounded-2xl group-hover:bg-white transition-all duration-300 transform group-hover:scale-110">
                      <Icon className={`w-8 h-8 text-gray-600 ${social.color} transition-colors duration-300`} />
                    </div>
                    <span className="font-bold text-gray-900 text-lg group-hover:text-gray-800 transition-colors duration-300">{social.name}</span>
                  </div>
                </Link>
              );
            })}
